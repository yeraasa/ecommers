    ...
    <div class="">
        ...
        <main class="flex-1 overflow-y-auto">
            <section class="@container">
                <div class="relative m-4 min-h-125 flex flex-col justify-end p-8 md:p-16 rounded-xl overflow-hidden group">
                ...
                <div class="grid grid-cols-5 gap-2">
                    @foreach ($items as $item)
                        <a href="{{ route('products.detail', $item->id) }}">
                            <div
                                class="flex flex-col h-auto gap-2 p-4 rounded-lg border border-slate-200">
